...
export function ConfirmDeleteDialog({
  ...
  function clickDelete(itemId: string) {
    deleteItemId(itemId);
    setOpen(false);
  }
  return (
      ...
      <Transition.Root show={open} as={Fragment}>
        ...
        >
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <div className="fixed inset-0 bg-primary bg-opacity-10 transition-opacity " />
          </Transition.Child>
          <div className="z-10 inset-0 overflow-y-auto">
            <div className="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
              ...
              >
                <Dialog.Panel className="bg-BG rounded-lg px-4  pb-4 text-left overflow-hidden border-BG-text border-2 transform transition-all sm:my-8 sm:max-w-lg sm:w-full sm:p-6">
