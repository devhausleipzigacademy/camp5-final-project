...
export const ontology = {
	Kitchen: {
		...
		Cookware: [
			...
			new Leaf("Other Cookware", ["Age", "Condition", "Brand", "Material"]),
		],
		Cutlery: [
			...
			new Leaf("Other Cutlery", ["Age", "Condition", "Brand", "Material"]),
		],
		Dishes: [
...
export const { leafPathMap, leafDetailsMap, leaves } = [
